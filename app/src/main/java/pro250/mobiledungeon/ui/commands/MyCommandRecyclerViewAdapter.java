...
public class MyCommandRecyclerViewAdapter extends RecyclerView.Adapter<MyCommandRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<Command> mValues;

    public MyCommandRecyclerViewAdapter(List<Command> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_command, parent, false);
